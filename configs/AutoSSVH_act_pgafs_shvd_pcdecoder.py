from AutoSSVH_act import *

# PCMR: prototype-conditioned masked reconstruction on top of PGAFS + SHVD.
...
file_path = f"{save_dir}/{model_name}_{nbits}bit_pgafs_shvd_pcdec_g005_sw002_p035"
log_path = f"{home_root}logs/{dataset}_{nbits}bit_pgafs_shvd_pcdec_g005_sw002_p035"
